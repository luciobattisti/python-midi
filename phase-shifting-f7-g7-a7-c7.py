...
chord_progression = ["Fdom7", "Fdom7", "Fdom7", "Fdom7", 
                     "Gdom7", "Gdom7", "Gdom7", "Gdom7",
                     "Adom7", "Adom7", "Adom7", "Adom7",
                     "Cdom7", "Cdom7", "Cdom7", "Cdom7"]
...
with open(os.path.join(output_dir, "phase-shifting-f7-g7-a7-c7-0.mid"), "wb") as fp:
    MyMIDI.writeFile(fp)
...
os.makedirs(output_dir, exist_ok=True)
with open(os.path.join(output_dir, "phase-shifting-f7-g7-a7-c7-1.mid"), "wb") as fp:
    MyMIDI.writeFile(fp)
