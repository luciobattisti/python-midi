...
chord_progression = ["Fmaj7", "Fmaj7", "Fmaj7", "Fmaj7", 
...
with open(os.path.join(output_dir, "phase-shifting-f-c-a-g-0.mid"), "wb") as fp:
    MyMIDI.writeFile(fp)
...
os.makedirs(output_dir, exist_ok=True)
with open(os.path.join(output_dir, "phase-shifting-f-c-a-g-1.mid"), "wb") as fp:
    MyMIDI.writeFile(fp)
